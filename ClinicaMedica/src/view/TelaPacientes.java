...
public class TelaPacientes extends JFrame {
    ...
    private static final Color VERDE_CLARO = new Color(76, 175, 80);
    ...
    public TelaPacientes(Usuario usuario) {
        ...
        JButton btnNovo = criarBotao("✚ Novo Paciente", VERDE_MEDIO);
        ...
        // Tabela
        String[] colunas = {"ID", "Nome", "BI", "Data Nasc.", "Telefone", "Email"};
        ...
        scroll.setBackground(CINZA_FUNDO);
    ...
    private void carregarTabela() {
        ...
        List<Paciente> pacientes = controller.buscarTodos();
    ...
    private void buscar() {
        ...
        modeloTabela.setRowCount(0);
        List<Paciente> pacientes = controller.buscar(termo);
        for (Paciente p : pacientes) {
            modeloTabela.addRow(new Object[]{
                    p.getId(), p.getNome(), p.getBi(),
                    p.getDataNascimento(), p.getTelefone(), p.getEmail()
    ...
    private void abrirFormulario(Paciente paciente) {
        new FormularioPaciente(this, paciente, controller);
        carregarTabela();
    }
}